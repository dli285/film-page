...
function displayMovieDetails(details) {
    const addToFavoritesButton = document.querySelector('.favourite-button');
    addToFavoritesButton.addEventListener('click', (event) => {
      event.preventDefault();
    
      const movieTitle = document.querySelector('.movie-title h3').textContent;
      const favoritesList = document.querySelector('.favouritesul');
